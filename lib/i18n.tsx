...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    home_blogs: 'Blogs & news',
    home_videos: 'Videos',
    home_view_all: 'View all',
    home_blogs_empty: 'No blog posts to show yet.',
    home_videos_empty: 'No videos to show yet.',
    profile_messages_cta: 'Inbox & conversations',
    ...
    dashboard_host: 'Host',
    dashboard_tab_host: 'Host',
    dashboard_tab_guest_trips: 'My trips',
    profile_bio: 'Bio',
    profile_bio_placeholder: 'Tell hosts a little about you',
    profile_save_profile: 'Save profile',
    profile_profile_updated: 'Profile updated.',
    profile_update_failed: 'Could not update profile.',
    profile_become_host: 'Become a host',
    profile_become_host_confirm: 'You can list your homestay and accept bookings. Continue?',
    profile_become_host_success: 'You are now a host. Use the Host tab on the dashboard.',
    profile_section_host: 'Hosting',
    profile_become_host_desc: 'Share your home with travelers and earn income.',
    listing_share: 'Share',
    listing_nearby_title: 'Nearby homestays',
    search_homestay_name: 'Homestay name',
    search_category: 'Category',
    search_type: 'Type',
    search_sort_label: 'Sort',
    search_sort_default: 'Recommended',
    search_sort_price_low: 'Price: low to high',
    search_sort_price_high: 'Price: high to low',
    messages_cannot_send: 'You can no longer send messages for this booking.',
  ...
  ne: {
    ...
    home_featured: 'विशेष',
    home_blogs: 'ब्लग र समाचार',
    home_videos: 'भिडियोहरू',
    home_view_all: 'सबै हेर्नुहोस्',
    home_blogs_empty: 'अहिले देखाउन ब्लग छैन।',
    home_videos_empty: 'अहिले देखाउन भिडियो छैन।',
    profile_messages_cta: 'इनबक्स र कुराकानी',
    ...
    dashboard_tab_host: 'होस्ट',
    dashboard_tab_guest_trips: 'मेरो यात्राहरू',
    profile_bio: 'परिचय',
    profile_bio_placeholder: 'आफ्नो बारेमा छोटो लेख्नुहोस्',
    profile_save_profile: 'प्रोफाइल सेभ गर्नुहोस्',
    profile_profile_updated: 'प्रोफाइल अपडेट भयो।',
    profile_update_failed: 'प्रोफाइल अपडेट गर्न सकिएन।',
    profile_become_host: 'होस्ट बन्नुहोस्',
    profile_become_host_confirm: 'तपाईंले होमस्टे सूचीबद्ध गर्न र बुकिङ स्वीकार गर्न सक्नुहुन्छ। जारी राख्ने?',
    profile_become_host_success: 'अब तपाईं होस्ट हुनुहुन्छ। ड्यासबोर्डमा होस्ट ट्याब प्रयोग गर्नुहोस्।',
    profile_section_host: 'होस्टिङ',
    profile_become_host_desc: 'यात्रुहरूसँग आफ्नो घर साझा गर्नुहोस् र कमाउनुहोस्।',
    listing_share: 'साझा गर्नुहोस्',
    listing_nearby_title: 'नजिकका होमस्टेहरू',
    search_homestay_name: 'होमस्टेको नाम',
    search_category: 'श्रेणी',
    search_type: 'प्रकार',
    search_sort_label: 'क्रमबद्ध',
    search_sort_default: 'सिफारिस',
    search_sort_price_low: 'मूल्य: कमदेखि बढी',
    search_sort_price_high: 'मूल्य: बढीदेखि कम',
    messages_cannot_send: 'यो बुकिङको लागि अब सन्देश पठाउन सकिँदैन।',
